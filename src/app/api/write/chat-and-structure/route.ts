...
### 重要重點
- 確保最後整合內容的語詞與邏輯，有效呼應前述對話內容，讓最終結論如同對話直煉生成。
...
對話內容：兩人對話內容
品牌受眾喜歡聽什麼：品牌／受眾觀察洞察
撰寫文章：以對白直敘，分三段，包含問題、嚴重性、解決方法

撰寫文章並非只是整理，而是希望按照對話順序，去撰寫出段落中要求的內容，以保證撰寫的內容有如對話般通順。
...
輸出問題陳述，要以對話中的人物遇到的問題為主，而不是概述或許多人，並說出他們的心聲
應在問題描述時，需回答我們將提供的解決方案的好處
嚴重性，需回答我們將提供的解決方案的好處
